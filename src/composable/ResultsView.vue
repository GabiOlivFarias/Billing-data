<template>
  <div class="md:w-full md:max-w-screen-md bg-light-red border-4 border-solid border-secundary rounded-md flex justify-center">
    <div class="flex flex-col items-center p-2 w-full">
      <h1 class="font-bold text-3xl flex justify-center pt-4 mb-8 md:mb-16">
        {{ $t('view.to_see') }}
      </h1>
      <div class="flex flex-col md:flex-row justify-center items-center p-2 md:space-x-4 w-full">
